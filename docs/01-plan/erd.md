...
| Phase | 범위 | Entity |
|-------|------|--------|
| **Phase 1 — Discover** | 디자이너 탐색, 맵뷰, 필터, 찜하기 | User, DesignerProfile, Salon, Portfolio, KeywordCategory, Keyword, DesignerKeyword, Favorite |
| **Phase 2 — Booking & Review** | 시술 메뉴, 예약, 리뷰 | Service, Booking, Review |
| **Phase 3 — Chat** | 1:1 채팅 | ChatRoom, ChatMessage |
...
| 대상 | 비정규화 필드 | Phase | 이유 |
|------|-------------|-------|------|
| DesignerProfile | `rating_avg`, `review_count` | Phase 2에서 활성화 | 카드 목록에서 매번 Review 집계 방지 |
